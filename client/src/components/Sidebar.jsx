    ...
    <div className="w-1/6 bg-blue-100 p-2 overflow-y-auto shadow-lg">
      <ul>
        ...
        <Link to="/home/update-employee">
          <li className="mb-2 rounded-md p-2 bg-blue-100 hover:bg-blue-200 transition-colors duration-300">
            <span className="text-blue-600 hover:text-blue-800 flex gap-3 line-clamp-1"><GrDocumentUpdate className='mt-1'/>Update Employee</span>
          </li>
        </Link>
        <Link to="/home/search-employee">
          <li className="mb-2 rounded-md p-2 bg-blue-100 hover:bg-blue-200 transition-colors duration-300">
            <span className="text-blue-600 hover:text-blue-800 flex gap-3"><FaSearch className='mt-1' />Search Employee</span>
          </li>
        </Link>
        <Link to="/home/list-employees">
          <li className="mb-2 rounded-md p-2 bg-blue-100 hover:bg-blue-200 transition-colors duration-300">
            <span className="text-blue-600 hover:text-blue-800 flex gap-3"><FaListUl className='mt-1'/>List Employees</span>
          </li>
        </Link>
        <Link to="/home/list-bank-details">
          <li className="mb-2 rounded-md p-2 bg-blue-100 hover:bg-blue-200 transition-colors duration-300">
            <span className="text-blue-600 hover:text-blue-800 flex gap-3"><BsBank2 className='mt-1'/>List Bank Details</span>
          </li>
        </Link>
        ...
        <Link to="/home/generate-slip">
          <li className="mb-2 rounded-md p-2 bg-blue-100 hover:bg-blue-200 transition-colors duration-300">
            <span className="text-blue-600 hover:text-blue-800 flex gap-3"><AiTwotoneFileAdd className='mt-1 scale-125'/>Add Slip</span>
          </li>
        </Link>
